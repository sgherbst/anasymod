...
class VivadoBuild():
    ...
    def build(self):
        ...
        self.v.println('launch_runs synth_1 -jobs {0}'.format(self.target.prj_cfg.vivado_config.num_cores))
        ...
        self.v.println('launch_runs impl_1 -to_step write_bitstream -jobs {0}'.format(self.target.prj_cfg.vivado_config.num_cores))
    ...
    def run_FPGA(self):
        self.v.use_templ(TemplEXECUTE_FPGA_SIM(target=self.target))
