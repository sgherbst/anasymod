...
def main():
    ...
    model.add_signal(AnalogSignal('v_cap_tx', 50))
    model.add_signal(AnalogSignal('v_cap_rx', 50))
    ...
    model.add_signal(AnalogSignal('v_det_tx', 50))
    model.add_signal(AnalogSignal('v_hpf_tx', 25))
    ...
    model.add_signal(AnalogSignal('v_det_rx', 25))
    model.add_signal(AnalogSignal('v_hpf_rx', 10))
